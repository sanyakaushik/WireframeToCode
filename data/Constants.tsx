...
- Start and end with the code only. Do not include anything other than valid Javascript/React code.
- Only give react+ tailwindcss code and do not write any text other than code
- You are a code generator. Return only valid JavaScript/React code inside triple backticks. Do not include commentary or markdown.
`,
